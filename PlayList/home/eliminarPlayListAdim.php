	...
	<body>
		<form action=""method="post" enctype="" onsubmit="">
			...
			<div id="divEliminarUsuario" class="eliminar">
					...
					<input type="submit" name="btnBuscarPlaylist" id="btnBuscarPlaylist" value="Buscar" class="boton"/>
				
				<?php 
						if(isset($_POST['btnBuscarPlaylist']))
						{
							$like = " where (p.nombre like '%".$_POST['txtNombrePlaylist']."%')";								
						}
						else
						{
							$like = "";
						}
					include('listarElimiarPlaylist.php');		
				?>
			</div>
